...
('code_aliasing','What does Python print?\na = [[0]] * 3\na[0].append(1)\na[1] = [2]\na[2][0] = 9\nprint(a)\nReturn JSON only: {"result": value}.',{'result':[[9,1],[2],[9,1]]}),
...
for name,prompt,expected in cases:
 body={'model':model,'messages':[{'role':'user','content':prompt}],'max_tokens':2048,'temperature':0,'reasoning_effort':'medium','seed':42}
