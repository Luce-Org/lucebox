...
CONFIGS = {
    ...
    "compression_on":   {  # only pflash compression (no prefix cache; BSA is part of the pflash defaults)
...
SERVER_BIN = os.environ.get("LUCE_SERVER_BIN", "server/build/luce_server")
