...
// array. When non-empty, tool-capable templates inject a tool preamble into
// the system message instructing the model how to emit <tool_call> tags.
// `tool_call_required` strengthens that instruction for OpenAI
// `tool_choice="required"` and forced-function requests.
