...
| `DFLASH_PREFIX_CACHE_SLOTS` | architecture default (`8`; DeepSeek `4`) | Container-entrypoint equivalent of `--prefix-cache-slots`; not read directly by the native binary. |
