...
source_sha = '4bf727077cf007352997798edc52f32c1f887023'
pinned = {
    binary: '4dc9430cd56ca5afe6e649adfa22ad5065b2c97cede86d0ac0b75b2f9296377e',
    ...
    build / 'ggml/src/libggml-cpu.so.0': 'b33faf3a600eeff2bea8b692360cff6de397aaf3082ea0c73a9f3a1af9ee70d2',
    build / 'ggml/src/ggml-hip/libggml-hip.so.0': 'b8991450ee422983b91cfbfcdf8d6b612e92f62f1128c6cce0c6b3e37ff8ef7e',
}
...
summary = {'status': 'ISSUES', 'features': 'ISSUES', 'embeddings': 'NOT_QUALIFIED',
           ...
           'scope': 'standalone component; no chat/server acceptance', 'component_only': component_only,
...
try:
    ...
    dump('provenance.json', {'source_sha': source_sha, 'pinned': {str(p): s for p, s in pinned.items()},
                           'shared_libraries_and_python': software, 'fixtures': fixtures,
