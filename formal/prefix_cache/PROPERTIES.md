...
Default local runs cover a symbolic fresh-cache prepare/confirm/lookup path
for capacities 1–4. Extended local runs widen the capacity domain to 1–16.
Each generated prefix has one to three tokens and belongs to one of three
branches.
