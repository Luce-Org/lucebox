...
CI integration and its base-revision blob loading are owned by the companion
planner.  This script is intentionally not the authoritative CI implementation.
"""
